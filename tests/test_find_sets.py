...
class TestFindSets(unittest.TestCase):
    def test_basic__find_three__no_wilds(self):
        hand = [
            H3,
            C3,
        ]
    ...
    def test_basic__one_card_two_wilds(self):
        hand = [
            H3,
            C3,
        ]
    ...
    def test_basic__two_options__one_wild(self):
        hand = [
            H3,
            C3,
        ]
